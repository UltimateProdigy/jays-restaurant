...
const Food: React.FC = () => {
    const groupedFood: GroupedFood = foodMenu.reduce((acc: GroupedFood, food: FoodItem) => {
    ...
    const categoryColors: CategoryColors = {
        'Rice Dishes': 'from-orange-500 to-red-500',
        'Swallow & Soup': 'from-green-500 to-teal-500',
        'Soup': 'from-blue-500 to-cyan-500',
        'Grilled': 'from-yellow-500 to-orange-500',
        'Sides': 'from-purple-500 to-pink-500',
        'Appetizer': 'from-indigo-500 to-purple-500'
    };
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 py-12 px-4">
            <div className="max-w-6xl mx-auto text-center mb-16">
                <div className="relative">
                    ...
                    <div className="absolute -bottom-4 -left-8 text-3xl animate-pulse">🌶️</div>
                </div>
                <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
                    Savor the authentic taste of Nigeria with our carefully crafted traditional dishes
                </p>
                <div className="w-32 h-1 bg-gradient-to-r from-orange-500 to-red-500 mx-auto mt-6 rounded-full"></div>
            </div>

            <div className="max-w-7xl mx-auto space-y-20">
                {Object.entries(groupedFood).map(([category, foods]: [string, FoodItem[]]) => (
                                ...
                                >
                                    ...
                                    <div className="absolute top-4 left-4 flex space-x-1">
                                        {[...Array(3)].map((_, i: number) => (
                                            <span key={i} className="text-red-500 text-sm opacity-70 group-hover:opacity-100 transition-opacity duration-300">
                                                🌶️
                                            </span>
                                        ))}
                                    </div>
            ...
            <div className="max-w-4xl mx-auto mt-24 text-center">
                <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 backdrop-blur-xl border border-orange-500/30 rounded-3xl p-8">
                    ...
                    <p className="text-slate-300 mb-6">
                        All our dishes are prepared with fresh, locally sourced ingredients and traditional Nigerian spices for an authentic taste experience.
                    </p>
