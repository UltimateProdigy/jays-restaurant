...
const SpringRollsPage: React.FC = () => {
  const navigate = useNavigate();

  const springRolls = foodMenu.filter(
    (food: FoodItem) => food.category === "Spring Roll"
  );
  ...
  return (
    <div
      ...
      className="min-h-screen bg-gradient-to-br from-slate-900 via-yellow-900 to-slate-900 py-12 px-4 bg-center bg-no-repeat backdrop-blur-md bg-fixed md:bg-local"
    >
      <div className="max-w-6xl mx-auto text-center mb-16">
        <div className="relative">
          <h1 className="text-6xl md:text-7xl font-bold bg-gradient-to-r from-yellow-400 via-orange-500 to-amber-600 bg-clip-text text-transparent mb-6">
            Spring Rolls
          </h1>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {springRolls.map((food: FoodItem, index: number) => (
            <div
              key={food.id}
      ...
      <div className="max-w-4xl mx-auto mt-24 text-center">
        <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 backdrop-blur-xl border border-yellow-500/30 rounded-3xl p-8">
          ...
          <p className="text-slate-300 mb-6">
            All our spring rolls are prepared with fresh, locally sourced
...
export default SpringRollsPage;
