...
const AsianPage: React.FC = () => {
  ...
  const asian = desertMenu.filter(
    (food: FoodItem) => food.category === "Asian Inspiration"
  );

  const categoryColor = "from-cyan-400 to-blue-500";
  const categoryIcon = "🍜";
    ...
    >
      <div className="max-w-6xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
          Delicious asian foods perfect for any occasion
        </p>
        <div
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {asian.map((food: FoodItem, index: number) => (
            <div
              key={food.id}
