...
const RicePage: React.FC = () => {
  ...
  const rice = desertMenu.filter(
    (food: FoodItem) => food.category === "Rice and Signature Specialties"
  );

  const categoryColor = "from-emerald-400 to-teal-500";
  const categoryIcon = "🍚";
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {rice.map((food: FoodItem, index: number) => (
            <div
              key={food.id}
