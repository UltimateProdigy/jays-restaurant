...
const Desert: React.FC = () => {
  const groupedDeserts: GroupedDeserts = desertMenu.reduce(
    (acc: GroupedDeserts, desert: DesertItem) => {
  ...
  const categoryColors: CategoryColors = {
    "Steaks & Premium Cuts": "from-amber-400 to-orange-500",
    "Pasta Selection": "from-purple-500 to-pink-500",
    "Asian Inspiration": "from-cyan-400 to-blue-500",
    "Rice and Signature Specialties": "from-emerald-400 to-teal-500",
    "Seafood Delicacies": "from-blue-400 to-indigo-500",
    Salads: "from-violet-500 to-purple-600",
  ...
  const categoryIcons: { [key: string]: string } = {
    ...
    "Pasta Selection": "🍝",
    "Asian Inspiration": "🍜",
    "Rice and Signature Specialties": "🍚",
    "Seafood Delicacies": "🐟",
    Salads: "🥗",
    Dessert: "🍰",
  };
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto space-y-20">
        {Object.entries(groupedDeserts).map(
          ([category, deserts]: [string, DesertItem[]]) => (
                  ...
                  >
                    ...
                    <div className="absolute top-4 left-4 flex space-x-1">
                      {[...Array(3)].map((_, i: number) => (
                        <span
                          key={i}
                          className="text-yellow-300 text-sm opacity-70 group-hover:opacity-100 transition-opacity duration-300"
                        >
                          ✨
                        </span>
                      ))}
      ...
      <div className="max-w-4xl mx-auto mt-24 text-center">
        <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-xl border border-blue-500/30 rounded-3xl p-8">
          ...
          <h3 className="text-2xl font-bold text-white mb-4">
            Chef's Special Treats
          </h3>
          <p className="text-slate-300 mb-6">
            Our desserts and snacks are made with authentic Nigerian recipes,
            using locally sourced ingredients for that special homemade taste.
          </p>
