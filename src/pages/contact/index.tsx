...
const ContactUs = () => {
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-slate-900 py-12 px-4 bg-cover bg-center bg-no-repeat backdrop-blur-md"
      style={{
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all duration-500">
          <h2 className="text-3xl font-bold text-white mb-8 flex items-center">
            <span className="bg-gradient-to-r from-gray-500 to-yellow-500 text-white p-3 rounded-xl mr-4">
              📧
            </span>
            Send us a message
          </h2>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all duration-500">
            ...
            <div className="space-y-4 text-slate-300">
              <p className="flex items-center">
                ...
                17 Awolowo Avenue, Bodija, Ibadan.
              </p>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-white text-lg">
                    jaysplaceng@qualityservice.com
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="flex space-x-4 mt-2">
                    <a
                      href="#"
                      className="text-yellow-400 hover:text-pink-400 transition-colors duration-300 text-2xl"
                    >
                      <span className="sr-only">Facebook</span>
                      <Facebook />
                    </a>
                    <a
                      href="https://instagram.com/Jaysplaceng_/"
                      className="text-yellow-400 hover:text-pink-400 transition-colors duration-300 text-2xl"
                    >
